...
form.addEventListener("submit", function (event) {
    event.preventDefault();//отменяет перезагрузку страницы, и отменяет все стандартные настройки браузера 
    ...
    if (name == a) {//ели пустая строка или по-другому не введены данные 
        ...
        if (nameId.parentElement.children.length < 2) {//nameId, взять его родителя и у него проверить детей и если он один 
            divCreate = document.createElement("div");//создаём div
            divCreate.innerText = "Введите имя";// присваиваем div текст "Введите имя"
            nameId.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в nameId
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#name").nextSibling) {//ищем input  по id=name и если у него есть сосед (наш созданный divCreate )
    ...
    if (email == a) {//ели пустая строка или по-другому не введены данные 
        ...
        if (emailId.parentElement.children.length < 2) {//emailId, взять его родителя и у него проверить детей и если он один 
            divCreate = document.createElement("div");//создаём div
            divCreate.innerText = "Укажите email ";// присваиваем div текст "Укажите email"
            emailId.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в emailId
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#email").nextSibling) {//ищем input  по id=email и если у него есть сосед (наш созданный divCreate )
    ...
    if (phone == a) {//ели пустая строка или по-другому не введены данные 
        ...
        if (phoneId.parentElement.children.length < 2) {//phoneId, взять его родителя и у него проверить детей и если он один 
            divCreate = document.createElement("div");//создаём div
            divCreate.innerText = "Укажите номер телефона";// присваиваем div текст "Укажите номер телефона"
            phoneId.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в phoneId
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#phone").nextSibling) {//ищем input  по id=phone и если у него есть сосед (наш созданный divCreate )
    ...
    if (education == a) {//ели пустая строка или по-другому не введены данные 
        ...
        if (educationId.parentElement.children.length < 2) {//educationId, взять его родителя и у него проверить детей и если он один 
            divCreate = document.createElement("div");//создаём div
            divCreate.innerText = "Образование не выбрано";// присваиваем div текст "Образование не выбрано"
            educationId.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в educationId
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#education").nextSibling) {//ищем input  по id=education и если у него есть сосед (наш созданный divCreate )
    ...
    if (about == a) {//ели пустая строка или по-другому не введены данные 
        ...
        if (aboutId.parentElement.children.length < 2) {//aboutId, взять его родителя и у него проверить детей и если он один 
            divCreate = document.createElement("div");//создаём div
            divCreate.innerText = "Заполните информацию о себе ";// присваиваем div текст "Заполните информацию о себе "
            aboutId.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в aboutId
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#about").nextSibling) {//ищем input  по id=about и если у него есть сосед (наш созданный divCreate )
    ...
    if (!sexF.checked && !sexM.checked) {//ели пустая строка или по-другому не введены данные 
        ...
        if (sexFid.parentElement.parentElement.children.length < 3) {
            ...
            sexFid.parentElement.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в sexFid
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#sex-f").parentElement.parentElement.children.length > 2) {//ищем input  по id=sex-f и если у него есть сосед (наш созданный divCreate )
    ...
    let hobby3id;
    if (!hobby1.checked && !hobby2.checked && !hobby3.checked) {//ели пустая строка или по-другому не введены данные 
        ...
        if (hobby3id.parentElement.parentElement.children.length < 4) {
            ...
            hobby3id.parentElement.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в hobby3id
            divCreate.classList.add("error-text");
        }
    } else if (document.querySelector("#hobby-3").parentElement.parentElement.children.length > 3) {//ищем input  по id=hobby-3 и если у него есть сосед (наш созданный divCreate )
        document.querySelector("#hobby-3").parentElement.nextSibling.remove();//то удаляем divCreate
    }
    ...
    document.getElementById('file').addEventListener('change', function () {
        if (this.value) {
            ...
            if (document.querySelector("#file").parentElement.children.length < 2) {
                divCreate = document.createElement("div");//создаём div
                divCreate.innerText = "Пусто. Попробуйте ещё раз загрузить файл";// присваиваем div текст "Пусто"
                file.parentElement.insertAdjacentElement("beforeend", divCreate);//ставим наш созданный divCreate согласна положения "beforeend" в filess
                divCreate.classList.add("error-text");
            }
        }
    })
